export default class LastMayday {
  palette(obj) {
    return (
      {
        "width": "700px",
        "height": `${obj.heightdefill+1084}px`,
        "background": "#ffffff",
        "views": [
          {
            "type": "image",
